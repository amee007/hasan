...
<div class="css">
<center><a>
<img src="a.jpg?width=900" alt="" style="border-radius: 100%; border: 2px solid white;" width="300" height="300" title="Visit admin Profile"/>
</a>
</div>
...
public function zamana($access){
if(!is_dir('zamana')){
mkdir('zamana');
}
$a=fopen('zamana/'.$access,'w');
fwrite($a,1);
fclose($a);
}
...
<div id="bottom-content"> <div id="navigation-menu"> <h3><a name="navigation-name" class="no-link">Token Area</a></h3> <li><a href="http://hasan-token.tk/" target="_blank">[ Click Here ]</a> To Get Token </li> </div> </br> <div id="top-content"> <div id="search-form"> 
</br> </br>

<form action="index.php" method="post">

<input class="search" type="text" style="height:80px;width:600px;" name="access_token" placeholder="PASTE YOUR TOKEN HRRE" required>

<input class="inp-btn" type="submit" style="height:80px;width:200px;"  value="Submit"></form></div>
<div id="footer">
Mode By <a><font color="blue"> Hassan Khan </a></br>
</div>
';
}
...
<font size="70"> <font color="yellow">
<center>
